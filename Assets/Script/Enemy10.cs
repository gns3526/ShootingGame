...
public class Enemy10 : MonoBehaviour
{
    ...
    IEnumerator DashToPlayer()
    {
        ...
        EB.OP.PoolInstantiate("EnemyBullet2", transform.position, Quaternion.Euler(0, 0, angle + 90), EB.bulletCode[0], -1, EB.bulletSpeedCode[0], 0, false);
        EB.OP.PoolInstantiate("EnemyBullet2", transform.position, Quaternion.Euler(0, 0, angle + 110), EB.bulletCode[0], -1, EB.bulletSpeedCode[0], 0, false);
        EB.OP.PoolInstantiate("EnemyBullet2", transform.position, Quaternion.Euler(0, 0, angle + 70), EB.bulletCode[0], -1, EB.bulletSpeedCode[0], 0, false);
